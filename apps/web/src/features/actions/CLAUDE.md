# features/actions — Module B frontend

Owner: 강민구. Backend counterpart: `modules/extraction/` (`/api/extraction`).
Screens: S17 action board, S18 action detail drawer, S15 actions tab — see `/docs/design/ui-spec.md`.
...
- **Call only `/api/extraction`.** Use `api.extraction()` from `@/shared/api/client`.
