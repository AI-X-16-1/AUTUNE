# features/transcript — Module A frontend

Owner: 김민경. Backend counterpart: `modules/audio/` (`/api/audio`).
Screens: S13 live transcript, S12 processing pipeline, S15 transcript tab — see `/docs/design/ui-spec.md`.
