...
Surface: gap report thread and generated question cards.
See docs/modules/gap.md.
"""
...
def register(app: App) -> None:
    ...
    """
    # TODO(박재경): register commands, actions and views for this module.
